...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> apiCall() async {
    ...
    response = await http.get(Uri.parse(
        'https://api.unsplash.com/photos/random/?client_id=2CMxxZJ5e6lez4zIPjhIpHRgezq49MNJfSLgGnMXlf0'));
    ...
    return SizedBox(
      ...
      child: Padding(
        ...
        child: ClipRRect(
          ...
          child: Image.network(photosLinks,
              fit: BoxFit.fitHeight, loadingBuilder: _loadingImage),
        ),
      ),
    );
  }
